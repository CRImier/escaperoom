...
class KnobPanel(ModbusDevice):
    ...
    def compare_knobs(self, *args, margin=50):
        truth_table = []
...
class TemperatureSensor(ModbusDevice):
    ...
    def get_raw_data(self):
        raw_data = self.request(temperature_register)
        return raw_data
...
class RFIDSensor(ModbusDevice):
    ...
    def __init__(modbus_id=1, reader_count=1, presence_register=3, reader_registers=[4]):
        self.modbus_id = modbus_id
